    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li <#if page_tab == 'topic'> class="active" </#if>><a href="/">钢琴介绍</a></li>
                <li <#if page_tab == 'label'> class="active" </#if>><a href="/">学校介绍</a></li>
                <li <#if page_tab == 'api'> class="active" </#if>><a href="/">APP介绍</a></li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <#else>
                    ...
                    <li <#if page_tab == 'login'> class="active" </#if>><a href="${baseUrl!}/login.html">Email登录</a></li>
                    <li <#if page_tab == 'reg'> class="active" </#if>><a href="${baseUrl!}/reg.html">Emial注册</a></li>
                    <li <#if page_tab == 'login'> class="active" </#if>><a href="${baseUrl!}/phonelogin.html">Phone登录</a></li>
                    <li <#if page_tab == 'reg'> class="active" </#if>><a href="${baseUrl!}/phonereg.html">Phone注册</a></li>
                    <li <#if page_tab == 'reg'> class="active" </#if>><a href="${baseUrl!}/apitest.html">接口测试</a></li>
                </#if>
            </ul>
        </div>
    </div>

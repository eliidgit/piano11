        ...
        <form role="form" class="form-horizontal" method="post" action="add">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="name" name="course.name" placeholder="课程名">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" id="part_number" class="form-control" name="course.part_number" placeholder="课程项目数">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea class="form-control" id="comments" rows="3" name="course.comments"></textarea>
                    </div>
                </div>

    ...
    <div class="box box-info">
        ...
        <form role="form" class="form-horizontal" method="post" action="edit">
            <div class="box-body">
                ...
                <input type="hidden" id="course_part_id" name="video.course_part_id" value="${video.course_part_id! }"/>


                <div class="form-group">
                    <label for="part" class="col-sm-2 control-label">所属栏目</label>
                    <div class="col-sm-4">
                        <input id="part_name" value="${part_name!}" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="name" name="video.source_index" value="${video.source_index! }"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="name" name="video.name" value="${video.name!}" placeholder="视频名">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="author" name="video.author_name" value="${video.author_name!}" placeholder="作者姓名">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input id="avatar_path" name="video.author_avatar" type="hidden" value="${video.author_avatar!}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input id="pic-upload" name="pic-upload" class="file" type="file" multiple
                               data-min-file-count="1">
                        <input id="pic_path" name="video.pic_path" type="hidden" value="${video.pic_path!}"/>
                ...
                <div class="form-group">
                    ...
                    <#--<input id="video-upload" name="video-upload" class="file" type="file">-->
                        <input id="path" name="video.path" value="${video.path!}" type="hidden"/>

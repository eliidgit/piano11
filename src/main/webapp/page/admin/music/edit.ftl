    ...
    <div class="box box-info">
        ...
        <form role="form" class="form-horizontal" method="post" action="edit">
            <div class="box-body">
                ...
                <input type="hidden" id="course_part_id" name="music.course_part_id" value="${music.course_part_id! }"/>
                <input type="hidden" id="id" name="music.id" value="${music.id! }"/>
                <div class="form-group">
                    <label for="part" class="col-sm-2 control-label">所属栏目</label>
                    <div class="col-sm-4">
                        <input id="part_name"  value="${part_name! }" class="form-control"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="name" name="music.source_index"   placeholder="示例:10,20..."  value="${music.source_index!}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="name" name="music.name"  placeholder="音乐名" value="${music.name!}">
                    </div>
                </div>
				<div class="form-group">
                    <label for="name" class="col-sm-2 control-label">音色</label>
                    <div class="col-sm-4">
                        <select onchange="changeChild(this)"  class="form-control" id="tone_id" >
                            <option  value="">[请选择]</option>

                        	<#list tones! as list>
                     	<option <#if   parent_tone_id !=0><#if parent_tone_id = list.id> selected="selected" </#if> </#if>  value="${list.id! }">${list.name! }</option>
                            </#list>


                        </select>
                        <select id="child_tone_id" name="music.tone_id"  class="form-control" >

                            <#list child_tones! as list1>
                                <option <#if  parent_tone_id !=0><#if tone_id = list1.ids> selected="selected" </#if> </#if>  value="${list1.ids! }">${list1.name! }</option>
                            </#list>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input id="stave_path" name="music.stave_path" value="${music.stave_path! }" type="hidden" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input id="midi-upload" name="midi-upload" class="file" type="file" multiple
                               data-min-file-count="1">
                        <input id="midi_path" name="music.midi_path" value="${music.midi_path! }" type="hidden"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input id="ogg-upload" name="ogg-upload" class="file" type="file" multiple
                               data-min-file-count="1">
                        <input id="ogg_path" name="music.ogg_path" value="${music.ogg_path! }" type="hidden"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input id="txt-a-upload" name="txt-a-upload" class="file" type="file" multiple
                               data-min-file-count="1">
                        <input id="txt_a_path" name="music.txt_a" value="${music.txt_a! }" type="hidden"/>
                        <br>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input id="txt-b-upload" name="txt-b-upload" class="file" type="file" multiple
                               data-min-file-count="1">
                        <input id="txt_b_path" name="music.txt_b" value="${music.txt_b! }" type="hidden"/>
                        <br>
                    </div>
                </div>

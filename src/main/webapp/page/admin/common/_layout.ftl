...
<head>
    ...
    <link href="${baseUrl!}/static/bootstrap-fileinput/css/fileinput.css" media="all" rel="stylesheet" type="text/css" />
    <script src="${baseUrl!}/static/bootstrap-fileinput/js/fileinput.js" type="text/javascript"></script>
    <script src="${baseUrl!}/static/bootstrap-fileinput/js/locales/zh.js" type="text/javascript"></script>


    <#--引入全局JS-->
    <script src="${baseUrl!}/static/js/jfinalshiromh.common.js" type="text/javascript"></script>

        ...
        <form role="form" class="form-horizontal" method="post" action="edit">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="name" name="homework.name"
                               value="${homework.name!}" placeholder="作业名">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea class="form-control" id="content" rows="3" name="homework.content">
                        ${homework.content!}
                        </textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input id="pics_path" name="homework.pics_path" value="${homework.pics_path!}" type="hidden"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input id="ogg-upload" name="ogg-upload" class="file" type="file" multiple
                               data-min-file-count="1">
                        <input id="ogg_path" name="homework.ogg_path" value="${homework.ogg_path!}" type="hidden"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="answer" name="homework.answer"
                               value="${homework.answer!}" placeholder="问题答案">
                    </div>
                </div>

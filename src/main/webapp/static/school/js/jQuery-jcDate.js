...
(function($, factory){
    ...
    $.fn.jcDate = function(options) {
        ...
        return $(this).each(function(idx, item) {
            if($("#jcDate").length == 0){
                $("body").prepend("<div id='jcDate'><input type='hidden' value='' id='dateHideText' /><div id='jcDateTt1'><a id='d_prev'></a><div><span></span><b>年</b></div><a id='d_next'></a></div><div class='clear'></div><div id='jcDateTt2'><a id='d_prev0'></a><div><samp></samp><b>月</b></div><a id='d_next0'></a></div><dl id='jcYeas'></dl><dl id='jcMonth'></dl><div id='jcDayWrap'><dl id='jcDayCon'></dl><div id='jcDateMax'><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul></div></div></div>");
            }
            var $dateInput = $(item),
                $window = $(window),
                dateObj = new Date(),
            ...
            function mAnimate(index){
                ...
                $month.text(index+1);
                $jcDateMax.animate({ "left":-index*230 },options.Speed);
            }
            ...
            $dateInput.addClass(options.Class).off().on(options.Event,function(e){
                    ...
                    var iof = $(this).offset();
                    $jcDate.css({ "left" : iof.left+options.Left,"top" : iof.top+options.Top+20 });
